...
final class VideoTrackMenu extends TrackMenu {
    ...
    VideoTrackMenu(OutOfProcessMediaPlayerComponent mediaPlayerComponent) {
        super(mediaPlayerComponent, "Video Track", 'v');
    }
    ...
    protected Action createAction(final TrackDescription trackDescription) {
        return new AbstractAction(trackDescription.description()) {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                mediaPlayerComponent.mediaPlayer().video().setTrack(trackDescription.id());
            }
        };
    }
    ...
    protected List<TrackDescription> onGetTrackDescriptions() {
        return mediaPlayerComponent.mediaPlayer().video().trackDescriptions();
    }

    @Override
    protected int onGetSelectedTrack() {
        return mediaPlayerComponent.mediaPlayer().video().track();
    }
}
