...
final class SubtitleTrackMenu extends TrackMenu {
    ...
    SubtitleTrackMenu(OutOfProcessMediaPlayerComponent mediaPlayerComponent) {
        super(mediaPlayerComponent, "Sub Track", 't');
    }
    ...
    protected Action createAction(final TrackDescription trackDescription) {
        return new AbstractAction(trackDescription.description()) {
            public void actionPerformed(ActionEvent actionEvent) {
                mediaPlayerComponent.mediaPlayer().subpictures().setTrack(trackDescription.id());
            }
        };
    }
    ...
    protected List<TrackDescription> onGetTrackDescriptions() {
        return mediaPlayerComponent.mediaPlayer().subpictures().trackDescriptions();
    }

    @Override
    protected int onGetSelectedTrack() {
        return mediaPlayerComponent.mediaPlayer().subpictures().track();
    }
}
